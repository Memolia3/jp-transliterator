 ...
 * 変換処理の抽象基底クラス
 */
export declare abstract class AbstractTransliterator implements ITransliterator {
     ...
     */
    transliterate(str: string, options?: TransliterationOptions): OnePattern | Combinations | null | {
        error: string;
    };
    /**
     * 実際の変換処理を実装するメソッド
     ...
     */
    protected abstract processTransliteration(str: string, chunkSize: number): OnePattern | Combinations | null;
    /**
     * パターン配列生成メソッド
     * 入力文字列から変換パターンの配列を生成
     * @param str 入力文字列
...
//# sourceMappingURL=abstract-transliterator.d.ts.map